...
void ConstReverseMIteratorTests::testIteratorCreation_data()
{
    ...
    QTest::newRow("1: begin iterator") << m_PrimaryIntMatrix.constReverseMBegin(-2) << IntMatrixOptSizeType{3u} << IntMatrixOptSizeType{1u} << -2 << IntMatrixOptSizeType{0u};
    QTest::newRow("2: begin iterator") << m_PrimaryIntMatrix.constReverseMBegin(0) << IntMatrixOptSizeType{2u} << IntMatrixOptSizeType{0u} << 0 << IntMatrixOptSizeType{0u};
    QTest::newRow("3: begin iterator") << m_PrimaryIntMatrix.constReverseMBegin(1) << IntMatrixOptSizeType{1u} << IntMatrixOptSizeType{0u} << 1 << IntMatrixOptSizeType{0u};
    QTest::newRow("4: begin iterator") << m_PrimaryIntMatrix.constReverseMBegin(2, 1) << IntMatrixOptSizeType{3u} << IntMatrixOptSizeType{0u} << -1 << IntMatrixOptSizeType{0u};
    QTest::newRow("5: begin iterator") << m_PrimaryIntMatrix.constReverseMBegin(0, 2) << IntMatrixOptSizeType{2u} << IntMatrixOptSizeType{0u} << 0 << IntMatrixOptSizeType{0u};
    QTest::newRow("6: begin iterator") << m_PrimaryIntMatrix.constReverseMBegin(1, 0) << IntMatrixOptSizeType{1u} << IntMatrixOptSizeType{0u} << 1 << IntMatrixOptSizeType{0u};
    QTest::newRow("7: end iterator") << m_PrimaryIntMatrix.constReverseMEnd(-2) << IntMatrixOptSizeType{1u} << IntMatrixOptSizeType{3u} << -2 << IntMatrixOptSizeType{2u};
    QTest::newRow("8: end iterator") << m_PrimaryIntMatrix.constReverseMEnd(0) << IntMatrixOptSizeType{} << IntMatrixOptSizeType{3u} << 0 << IntMatrixOptSizeType{3u};
    QTest::newRow("9: end iterator") << m_PrimaryIntMatrix.constReverseMEnd(1) << IntMatrixOptSizeType{} << IntMatrixOptSizeType{2u} << 1 << IntMatrixOptSizeType{2u};
    QTest::newRow("10: end iterator") << m_PrimaryIntMatrix.constReverseMEnd(2, 1) << IntMatrixOptSizeType{0u} << IntMatrixOptSizeType{3u} << -1 << IntMatrixOptSizeType{3u};
    QTest::newRow("11: end iterator") << m_PrimaryIntMatrix.constReverseMEnd(0, 2) << IntMatrixOptSizeType{} << IntMatrixOptSizeType{3u} << 0 << IntMatrixOptSizeType{3u};
    QTest::newRow("12: end iterator") << m_PrimaryIntMatrix.constReverseMEnd(1, 0) << IntMatrixOptSizeType{} << IntMatrixOptSizeType{2u} << 1 << IntMatrixOptSizeType{2u};
    QTest::newRow("13: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator(1, 2) << IntMatrixOptSizeType{1u} << IntMatrixOptSizeType{2u} << -1 << IntMatrixOptSizeType{2u};
    QTest::newRow("14: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator(0, 0) << IntMatrixOptSizeType{0u} << IntMatrixOptSizeType{0u} << 2 << IntMatrixOptSizeType{0u};
    QTest::newRow("15: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator(2, 1) << IntMatrixOptSizeType{2u} << IntMatrixOptSizeType{1u} << -1 << IntMatrixOptSizeType{1u};
    QTest::newRow("16: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator(2, 0) << IntMatrixOptSizeType{2u} << IntMatrixOptSizeType{0u} << 0 << IntMatrixOptSizeType{0u};
    QTest::newRow("17: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator({-1, 0}) << IntMatrixOptSizeType{3u} << IntMatrixOptSizeType{0u} << -1 << IntMatrixOptSizeType{0u};
    QTest::newRow("18: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator({2, 0}) << IntMatrixOptSizeType{0u} << IntMatrixOptSizeType{0u} << 2 << IntMatrixOptSizeType{0u};
    QTest::newRow("19: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator({-1, 1}) << IntMatrixOptSizeType{2u} << IntMatrixOptSizeType{1u} << -1 << IntMatrixOptSizeType{1u};
    QTest::newRow("20: random iterator") << m_PrimaryIntMatrix.getConstReverseMIterator({0, 2}) << IntMatrixOptSizeType{0u} << IntMatrixOptSizeType{2u} << 0 << IntMatrixOptSizeType{2u};
}
