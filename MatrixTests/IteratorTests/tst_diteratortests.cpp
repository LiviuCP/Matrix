...
void DIteratorTests::testDifferenceOperator_data()
{
    ...
    QTest::newRow("3: random iterator, random iterator") << m_PrimaryIntMatrix.getDIterator(2, 1) << m_PrimaryIntMatrix.getDIterator({-1, 2}) << 1;
    QTest::newRow("4: random iterator, random iterator") << m_PrimaryIntMatrix.getDIterator(1, 2) << m_PrimaryIntMatrix.getDIterator({1, 0}) << -1;
    QTest::newRow("5: random iterator, end iterator") << m_PrimaryIntMatrix.getDIterator({-1, 0}) << m_PrimaryIntMatrix.dEnd(-1) << 3;
...
void DIteratorTests::testStdCount_data()
{
    ...
    QTest::newRow("3: random iterator, random iterator") << m_PrimaryIntMatrix.getDIterator(0, 1) << m_PrimaryIntMatrix.getDIterator({1, 0}) << -3 << 0;
    QTest::newRow("4: random iterator, random iterator") << m_SecondaryIntMatrix.getDIterator({1, 1}) << m_SecondaryIntMatrix.getDIterator(4, 5) << 4 << 1;
    QTest::newRow("5: random iterator, random iterator") << m_SecondaryIntMatrix.getDIterator(2, 3) << m_SecondaryIntMatrix.getDIterator({1, 4}) << 4 << 0;
}
...
void DIteratorTests::_buildOperatorPlusTestingTable()
{
    ...
    QTest::newRow("5: random iterator, begin iterator") << m_PrimaryIntMatrix.getDIterator({-1, 1}) << -2 << m_PrimaryIntMatrix.dBegin(1, 0);
    QTest::newRow("6: random iterator, begin iterator") << m_PrimaryIntMatrix.getDIterator({-1, 1}) << -1 << m_PrimaryIntMatrix.dBegin(1, 0);
    QTest::newRow("7: random iterator, random iterator") << m_PrimaryIntMatrix.getDIterator({-1, 1}) << 0 << m_PrimaryIntMatrix.getDIterator(2, 1);
    QTest::newRow("8: random iterator, random iterator") << m_PrimaryIntMatrix.getDIterator({-1, 1}) << 1 << m_PrimaryIntMatrix.getDIterator(3, 2);
    QTest::newRow("9: random iterator, end iterator") << m_PrimaryIntMatrix.getDIterator({-1, 1}) << 2 << m_PrimaryIntMatrix.dEnd(1, 0);
    QTest::newRow("10: random iterator, end iterator") << m_PrimaryIntMatrix.getDIterator({-1, 1}) << 3 << m_PrimaryIntMatrix.dEnd(1, 0);
