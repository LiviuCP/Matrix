...
void DIteratorTests::testArrowOperator()
{
    ...
    QVERIFY(m_StringMatrix.getDIterator(0, 1)->starts_with("de"));
    QVERIFY(m_StringMatrix.getDIterator(1, 1)->starts_with("mn"));
    QVERIFY(m_StringMatrix.getDIterator(1, 0)->starts_with("jk"));
