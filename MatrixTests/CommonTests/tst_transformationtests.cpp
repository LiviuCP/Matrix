...
void TransformationTests::testStringMatrixTranspose_data()
{
    ...
    QTest::newRow("same matrix") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{3, 2, {"First", "Fourth", "Second", "Fifth", "Third", "Sixth"}} << 3 << 3 << 3 << 3 << true;
    QTest::newRow("same matrix") << StringMatrix{} << StringMatrix{} << StringMatrix{} << 0 << 0 << 0 << 0 << true;
    QTest::newRow("different matrixes") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{2, 2, {"Seventh", "Eighth", "Ninth", "Tenth"}} << StringMatrix{3, 2, {"First", "Fourth", "Second", "Fifth", "Third", "Sixth"}} << 2 << 3 << 3 << 2 << false;
    QTest::newRow("different matrixes") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << StringMatrix{3, 2, {"First", "Fourth", "Second", "Fifth", "Third", "Sixth"}} << 2 << 3 << 3 << 2 << false;
    QTest::newRow("different matrixes") << StringMatrix{} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{} << 0 << 0 << 0 << 0 << false;
...
void TransformationTests::testStringMatrixCatByRow_data()
{
    ...
    QTest::newRow("scenario: all different") << StringMatrix{} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 3 << 2 << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{2, 3, {"Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 3 << 2 << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{4, 1, {"Seventh", "Eighth", "Ninth", "Tenth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 3 << 2 << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{3, 2, {"Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 3 << 2 << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::ALL_DIFFERENT << 0 << 0 << StringMatrix{};
    QTest::newRow("scenario: destination first") << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}} << ConcatMode::DESTINATION_FIRST << 3 << 2 << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}};
    ...
    QTest::newRow("scenario: destination second") << StringMatrix{1, 2, {"Fifth", "Sixth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}} << ConcatMode::DESTINATION_SECOND << 3 << 2 << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}};
    ...
    QTest::newRow("scenario: destination all") << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << ConcatMode::DESTINATION_ALL << 5 << 2 << StringMatrix{4, 2, {"First", "Second", "Third", "Fourth", "First", "Second", "Third", "Fourth"}};
    QTest::newRow("scenario: destination all") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::DESTINATION_ALL << 0 << 0 << StringMatrix{};
    QTest::newRow("scenario: source both") << StringMatrix{} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << ConcatMode::SOURCE_BOTH << 5 << 2 << StringMatrix{4, 2, {"First", "Second", "Third", "Fourth", "First", "Second", "Third", "Fourth"}};
...
void TransformationTests::testStringMatrixCatByColumn_data()
{
    ...
    QTest::newRow("scenario: all different") << StringMatrix{} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 1, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 2 << 3 << StringMatrix{2, 3, {"First", "Second", "Fifth", "Third", "Fourth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{3, 2, {"Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 1, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 2 << 3 << StringMatrix{2, 3, {"First", "Second", "Fifth", "Third", "Fourth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{1, 4, {"Seventh", "Eighth", "Ninth", "Tenth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 1, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 2 << 3 << StringMatrix{2, 3, {"First", "Second", "Fifth", "Third", "Fourth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{2, 3, {"Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 1, {"Fifth", "Sixth"}} << ConcatMode::ALL_DIFFERENT << 2 << 3 << StringMatrix{2, 3, {"First", "Second", "Fifth", "Third", "Fourth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::ALL_DIFFERENT << 0 << 0 << StringMatrix{};
    QTest::newRow("scenario: destination first") << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 1, {"Fifth", "Sixth"}} << ConcatMode::DESTINATION_FIRST << 2 << 3 << StringMatrix{2, 3, {"First", "Second", "Fifth", "Third", "Fourth", "Sixth"}};
    QTest::newRow("scenario: destination first") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::DESTINATION_FIRST << 0 << 0 << StringMatrix{};
    QTest::newRow("scenario: destination second") << StringMatrix{2, 1, {"Fifth", "Sixth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 1, {"Fifth", "Sixth"}} << ConcatMode::DESTINATION_SECOND << 2 << 3 << StringMatrix{2, 3, {"First", "Second", "Fifth", "Third", "Fourth", "Sixth"}};
    QTest::newRow("scenario: destination second") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::DESTINATION_SECOND << 0 << 0 << StringMatrix{};
    QTest::newRow("scenario: destination all") << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << ConcatMode::DESTINATION_ALL << 2 << 5 << StringMatrix{2, 4, {"First", "Second", "First", "Second", "Third", "Fourth", "Third", "Fourth"}};
    QTest::newRow("scenario: destination all") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::DESTINATION_ALL << 0 << 0 << StringMatrix{};
    QTest::newRow("scenario: source both") << StringMatrix{} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << ConcatMode::SOURCE_BOTH << 2 << 5 << StringMatrix{2, 4, {"First", "Second", "First", "Second", "Third", "Fourth", "Third", "Fourth"}};
    QTest::newRow("scenario: source both") << StringMatrix{} << StringMatrix{} << StringMatrix{} << ConcatMode::SOURCE_BOTH << 0 << 0 << StringMatrix{};
}
...
void TransformationTests::testStringMatrixSplitByRow_data()
{
    ...
    QTest::newRow("scenario: all different") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << StringMatrix{} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 1 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{1, 2, {"Seventh", "Eighth"}} << StringMatrix{} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 1 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << StringMatrix{2, 2, {"Ninth", "Tenth", "Eleventh", "Twelfth"}} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 2 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{1, 2, {"Seventh", "Eighth"}} << StringMatrix{2, 2, {"Ninth", "Tenth", "Eleventh", "Twelfth"}} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 2 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: source first") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << 2 << SplitMode::SOURCE_FIRST << 3 << 2 << 1 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: source first") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{2, 2, {"Ninth", "Tenth", "Eleventh", "Twelfth"}} << 2 << SplitMode::SOURCE_FIRST << 3 << 2 << 2 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: source second") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << 2 << SplitMode::SOURCE_SECOND << 2 << 2 << 3 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
    QTest::newRow("scenario: source second") << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{1, 2, {"Seventh", "Eighth"}} << StringMatrix{3, 2, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << 2 << SplitMode::SOURCE_SECOND << 2 << 2 << 3 << 2 << StringMatrix{2, 2, {"First", "Second", "Third", "Fourth"}} << StringMatrix{1, 2, {"Fifth", "Sixth"}};
}
...
void TransformationTests::testStringMatrixSplitByColumn_data()
{
    ...
    QTest::newRow("scenario: all different") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << StringMatrix{} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 2 << 1 << StringMatrix{2, 2, {"First", "Second", "Fourth", "Fifth"}} << StringMatrix{2, 1, {"Third", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{2, 1, {"Seventh", "Eighth"}} << StringMatrix{} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 2 << 1 << StringMatrix{2, 2, {"First", "Second", "Fourth", "Fifth"}} << StringMatrix{2, 1, {"Third", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << StringMatrix{2, 2, {"Ninth", "Tenth", "Eleventh", "Twelfth"}} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 2 << 2 << StringMatrix{2, 2, {"First", "Second", "Fourth", "Fifth"}} << StringMatrix{2, 1, {"Third", "Sixth"}};
    QTest::newRow("scenario: all different") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{2, 1, {"Seventh", "Eighth"}} << StringMatrix{2, 2, {"Ninth", "Tenth", "Eleventh", "Twelfth"}} << 2 << SplitMode::ALL_DIFFERENT << 2 << 2 << 2 << 2 << StringMatrix{2, 2, {"First", "Second", "Fourth", "Fifth"}} << StringMatrix{2, 1, {"Third", "Sixth"}};
    QTest::newRow("scenario: source first") << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{2, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth"}} << StringMatrix{} << 2 << SplitMode::SOURCE_FIRST << 2 << 3 << 2 << 1 << StringMatrix{2, 2, {"First", "Second", "Fourth", "Fifth"}} << StringMatrix{2, 1, {"Third", "Sixth"}};
...
void TransformationTests::testStringMatrixCopy_data()
{
    ...
    QTest::newRow("elements copied") << StringMatrix{5, 4, {"13th", "14th", "15th", "16th", "17th", "18th", "19th", "20th", "21st", "22nd", "23rd", "24th", "25th", "26th", "27th", "28th", "29th", "30th", "31st", "32nd"}} << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << 3 << 2 << 2 << 1 << 1 << 0 << StringMatrix{4, 3, {"First", "Second", "Third", "22nd", "23rd", "Sixth", "26th", "27th", "Ninth", "30th", "31st", "Twelfth"}};
    QTest::newRow("no rows to be copied") << StringMatrix{5, 4, {"13th", "14th", "15th", "16th", "17th", "18th", "19th", "20th", "21st", "22nd", "23rd", "24th", "25th", "26th", "27th", "28th", "29th", "30th", "31st", "32nd"}} << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << 0 << 2 << 2 << 1 << 1 << 0 << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}};
    QTest::newRow("no columns to be copied") << StringMatrix{5, 4, {"13th", "14th", "15th", "16th", "17th", "18th", "19th", "20th", "21st", "22nd", "23rd", "24th", "25th", "26th", "27th", "28th", "29th", "30th", "31st", "32nd"}} << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << 3 << 0 << 2 << 1 << 1 << 0 << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}};
    QTest::newRow("no elements to be copied") << StringMatrix{5, 4, {"13th", "14th", "15th", "16th", "17th", "18th", "19th", "20th", "21st", "22nd", "23rd", "24th", "25th", "26th", "27th", "28th", "29th", "30th", "31st", "32nd"}} << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}} << 0 << 0 << 2 << 1 << 1 << 0 << StringMatrix{4, 3, {"First", "Second", "Third", "Fourth", "Fifth", "Sixth", "Seventh", "Eighth", "Ninth", "Tenth", "Eleventh", "Twelfth"}};
}
