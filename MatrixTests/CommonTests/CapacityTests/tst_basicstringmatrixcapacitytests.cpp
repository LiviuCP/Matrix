...
void BasicStringMatrixCapacityTests::testCatByRow_data()
{
    ...
    QTest::newRow("2: different matrixes") << StringMatrix{{5, 7}, "Value2"} << StringMatrix{{4, 7}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: different matrixes") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{{10, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("4: different matrixes") << StringMatrix{{10, 22}, "Value2"} << StringMatrix{{16, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("5: different matrixes") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{{1, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u};
    QTest::newRow("6: different matrixes") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{{2, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u};
    QTest::newRow("7: different matrixes") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{{3, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("8: different matrixes") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{{4, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("9: different matrixes") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{{5, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("10: different matrixes") << StringMatrix{{1, 22}, "Value2"} << StringMatrix{{16, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{17u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("11: different matrixes") << StringMatrix{{2, 22}, "Value2"} << StringMatrix{{16, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("12: different matrixes") << StringMatrix{{3, 22}, "Value2"} << StringMatrix{{16, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{19u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("13: different matrixes") << StringMatrix{{4, 22}, "Value2"} << StringMatrix{{16, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("14: different matrixes") << StringMatrix{{5, 22}, "Value2"} << StringMatrix{{16, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("15: different matrixes") << StringMatrix{{c_LargeDimension2, 22}, "Value1"} << StringMatrix{{1, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("16: different matrixes") << StringMatrix{{c_LargeDimension1, 22}, "Value1"} << StringMatrix{{2, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("17: different matrixes") << StringMatrix{{1, 22}, "Value2"} << StringMatrix{{c_LargeDimension2, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("18: different matrixes") << StringMatrix{{2, 22}, "Value2"} << StringMatrix{{c_LargeDimension1, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("19_1a: different matrixes") << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension1 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_2a: different matrixes") << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_3a: different matrixes") << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_IncrHalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_4a: different matrixes") << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value2"} << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_5a: different matrixes") << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_6a: different matrixes") << StringMatrix{{c_IncrHalfMaxAllowedDimension, 22}, "Value2"} << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    }
    else
    {
        QTest::newRow("19_1b: different matrixes") << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension0 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_2b: different matrixes") << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension1 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_3b: different matrixes") << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_IncrHalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_4b: different matrixes") << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value2"} << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension1 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_5b: different matrixes") << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_6b: different matrixes") << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value1"} << StringMatrix{{c_IncrHalfMaxAllowedDimension, 22}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_7b: different matrixes") << StringMatrix{{c_IncrHalfMaxAllowedDimension, 22}, "Value2"} << StringMatrix{{c_DecrHalfMaxAllowedDimension, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_8b: different matrixes") << StringMatrix{{c_IncrHalfMaxAllowedDimension, 22}, "Value2"} << StringMatrix{{c_HalfMaxAllowedDimension, 22}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    }

    QTest::newRow("20: same matrix") << StringMatrix{{4, 7}, "Value1"} << StringMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: same matrix") << StringMatrix{{16, 22}, "Value1"} << StringMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
}
...
void BasicStringMatrixCapacityTests::testCatByColumn_data()
{
    ...
    QTest::newRow("2: different matrixes") << StringMatrix{{7, 5}, "Value2"} << StringMatrix{{7, 4}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: different matrixes") << StringMatrix{{22, 16}, "Value1"} << StringMatrix{{22, 10}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{26u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("4: different matrixes") << StringMatrix{{22, 10}, "Value2"} << StringMatrix{{22, 16}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{26u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("7: different matrixes") << StringMatrix{{22, 16}, "Value1"} << StringMatrix{{22, 3}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    QTest::newRow("8: different matrixes") << StringMatrix{{22, 16}, "Value1"} << StringMatrix{{22, 4}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("9: different matrixes") << StringMatrix{{22, 16}, "Value1"} << StringMatrix{{22, 5}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{21u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("10: different matrixes") << StringMatrix{{22, 1}, "Value2"} << StringMatrix{{22, 16}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{17u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("11: different matrixes") << StringMatrix{{22, 2}, "Value2"} << StringMatrix{{22, 16}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{18u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("12: different matrixes") << StringMatrix{{22, 3}, "Value2"} << StringMatrix{{22, 16}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{19u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("13: different matrixes") << StringMatrix{{22, 4}, "Value2"} << StringMatrix{{22, 16}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("14: different matrixes") << StringMatrix{{22, 5}, "Value2"} << StringMatrix{{22, 16}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{21u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("15: different matrixes") << StringMatrix{{22, c_LargeDimension2}, "Value1"} << StringMatrix{{22, 1}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("16: different matrixes") << StringMatrix{{22, c_LargeDimension1}, "Value1"} << StringMatrix{{22, 2}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("17: different matrixes") << StringMatrix{{22, 1}, "Value2"} << StringMatrix{{22, c_LargeDimension2}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("18: different matrixes") << StringMatrix{{22, 2}, "Value2"} << StringMatrix{{22, c_LargeDimension1}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("19_1a: different matrixes") << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension1 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_2a: different matrixes") << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_3a: different matrixes") << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_IncrHalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_4a: different matrixes") << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value2"} << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_5a: different matrixes") << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_6a: different matrixes") << StringMatrix{{22, c_IncrHalfMaxAllowedDimension}, "Value2"} << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    }
    else
    {
        QTest::newRow("19_1b: different matrixes") << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension0 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_2b: different matrixes") << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension1 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_3b: different matrixes") << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_IncrHalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_4b: different matrixes") << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value2"} << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension1 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_5b: different matrixes") << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_6b: different matrixes") << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value1"} << StringMatrix{{22, c_IncrHalfMaxAllowedDimension}, "Value2"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_7b: different matrixes") << StringMatrix{{22, c_IncrHalfMaxAllowedDimension}, "Value2"} << StringMatrix{{22, c_DecrHalfMaxAllowedDimension}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_8b: different matrixes") << StringMatrix{{22, c_IncrHalfMaxAllowedDimension}, "Value2"} << StringMatrix{{22, c_HalfMaxAllowedDimension}, "Value1"} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    }

    QTest::newRow("20: same matrix") << StringMatrix{{7, 4}, "Value1"} << StringMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: same matrix") << StringMatrix{{22, 16}, "Value1"} << StringMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
}
