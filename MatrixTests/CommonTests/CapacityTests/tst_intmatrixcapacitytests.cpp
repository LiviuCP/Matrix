...
void IntMatrixCapacityTests::testCatByRow_data()
{
    ...
    QTest::newRow("1: destination first") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("2: destination first") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("3: destination first") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("4: destination first") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("5: destination first") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("6: destination first") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("7: destination second") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("8: destination second") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("9: destination second") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("10: destination second") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("11: destination second") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("12: destination second") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("13: source both") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("14: source both") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("15: source both") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("16: source both") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("17: source both") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("18: source both") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{5u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("19: destination all") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("20: destination all") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("21: destination all") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("22: destination all") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("23: destination all") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("24: destination all") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{4u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("25: all different") << IntMatrix{{6, 7}, 3} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("26: all different") << IntMatrix{{6, 7}, 3} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("27: all different") << IntMatrix{{6, 7}, 3} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("28: all different") << IntMatrix{{6, 7}, 3} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("29: all different") << IntMatrix{{6, 7}, 3} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("30: all different") << IntMatrix{{6, 7}, 3} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    // column capacity too
    QTest::newRow("31: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("32: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("33: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("34: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("35: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("36: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("37: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("38: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("39: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("40: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("41: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("42: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("43: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("44: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("45: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("46: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("47: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("48: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("49: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("50: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    // additional tests
    QTest::newRow("51: all different") << IntMatrix{} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("52: all different") << IntMatrix{{7, 5}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("53: all different") << IntMatrix{{10, 5}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("54: all different") << IntMatrix{{6, 6}, -1} << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("55: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("56: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{15u} << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("57: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{15u} << matrix_size_t{31u} << matrix_size_t{26u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("58: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{15u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("59: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{15u} << matrix_size_t{33u} << matrix_size_t{28u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("60: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("61: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{31u} << matrix_size_t{26u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("62: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("63: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{33u} << matrix_size_t{28u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("64: all different") << IntMatrix{{12, 15}, -1} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{27u} << matrix_size_t{23u} << matrix_size_t{33u} << matrix_size_t{28u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("65: destination first") << IntMatrix{{16, 22}, 5} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("66: destination second") << IntMatrix{{10, 22}, -2} << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("67: destination all") << IntMatrix{{16, 22}, 5} << IntMatrix{{16, 22}, 5} << IntMatrix{{16, 22}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{40u} << matrix_size_t{27u} << matrix_opt_size_t{4u} << matrix_opt_size_t{2u};
    QTest::newRow("68: source both") << IntMatrix{{10, 22}, -2} << IntMatrix{{16, 22}, 5} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{40u} << matrix_size_t{27u} << matrix_opt_size_t{4u} << matrix_opt_size_t{2u};

    // empty matrix concatenation
    QTest::newRow("69: source both") << IntMatrix{{7, 6}, -1} << IntMatrix{} << IntMatrix{} << ConcatMode::SOURCE_BOTH << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_opt_size_t{} << matrix_opt_size_t{};
    QTest::newRow("70: all different") << IntMatrix{{7, 6}, -1} << IntMatrix{} << IntMatrix{} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_opt_size_t{} << matrix_opt_size_t{};
}
...
void IntMatrixCapacityTests::testCatByColumn_data()
{
    ...
    QTest::newRow("1: destination first") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("2: destination first") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("3: destination first") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("4: destination first") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("5: destination first") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("6: destination first") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("7: destination second") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("8: destination second") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("9: destination second") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("10: destination second") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("11: destination second") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("12: destination second") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("13: source both") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("14: source both") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("15: source both") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("16: source both") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("17: source both") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("18: source both") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{7u} << matrix_size_t{5u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("19: destination all") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("20: destination all") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("21: destination all") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("22: destination all") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("23: destination all") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("24: destination all") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 4}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{7u} << matrix_size_t{4u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("25: all different") << IntMatrix{{7, 6}, 3} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("26: all different") << IntMatrix{{7, 6}, 3} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("27: all different") << IntMatrix{{7, 6}, 3} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("28: all different") << IntMatrix{{7, 6}, 3} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("29: all different") << IntMatrix{{7, 6}, 3} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("30: all different") << IntMatrix{{7, 6}, 3} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};

    // row capacity too
    QTest::newRow("31: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("32: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("33: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("34: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("35: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("36: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("37: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("38: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("39: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("40: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("41: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("42: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("43: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("44: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("45: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("46: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("47: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("48: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("49: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("50: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{6u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};

    // additional tests
    QTest::newRow("51: all different") << IntMatrix{} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("52: all different") << IntMatrix{{5, 7}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("53: all different") << IntMatrix{{5, 10}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("54: all different") << IntMatrix{{6, 6}, -1} << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("55: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("56: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{15u} << matrix_size_t{12u} << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("57: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{15u} << matrix_size_t{12u} << matrix_size_t{26u} << matrix_size_t{31u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("58: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{15u} << matrix_size_t{12u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("59: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{15u} << matrix_size_t{12u} << matrix_size_t{28u} << matrix_size_t{33u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("60: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("61: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{26u} << matrix_size_t{31u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("62: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("63: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{28u} << matrix_size_t{33u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("64: all different") << IntMatrix{{15, 12}, -1} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{23u} << matrix_size_t{27u} << matrix_size_t{28u} << matrix_size_t{33u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("65: destination first") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::DESTINATION_FIRST << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("66: destination second") << IntMatrix{{22, 10}, -2} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::DESTINATION_SECOND << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
    QTest::newRow("67: destination all") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 16}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{40u} << matrix_opt_size_t{2u} << matrix_opt_size_t{4u};
    QTest::newRow("68: source both") << IntMatrix{{22, 10}, -2} << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_BOTH << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{40u} << matrix_opt_size_t{2u} << matrix_opt_size_t{4u};

    // empty matrix concatenation
    QTest::newRow("69: source both") << IntMatrix{{6, 7}, -1} << IntMatrix{} << IntMatrix{} << ConcatMode::SOURCE_BOTH << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_opt_size_t{} << matrix_opt_size_t{};
    QTest::newRow("70: all different") << IntMatrix{{6, 7}, -1} << IntMatrix{} << IntMatrix{} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_opt_size_t{} << matrix_opt_size_t{};
}
