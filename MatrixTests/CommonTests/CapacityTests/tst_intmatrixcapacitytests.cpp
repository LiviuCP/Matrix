...
void IntMatrixCapacityTests::testCatByRow_data()
{
    ...
    QTest::newRow("1: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("2: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{7u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("6: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{{4, 7}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("7: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("8: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("11: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("12: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    // column capacity too
    QTest::newRow("13: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{7u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("14: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{7u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("15: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("16: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{9u} << matrix_size_t{9u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("17: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{9u} << matrix_size_t{6u} << matrix_size_t{9u} << matrix_size_t{7u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("18: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{9u} << matrix_size_t{7u} << matrix_size_t{9u} << matrix_size_t{7u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("19: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("20: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{9u} << matrix_size_t{9u} << matrix_size_t{9u} << matrix_size_t{9u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("21: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{10u} << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{7u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("22: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{10u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{7u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("23: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("24: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{10u} << matrix_size_t{9u} << matrix_size_t{10u} << matrix_size_t{9u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("25: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{11u} << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{7u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("26: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{11u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{7u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("27: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("28: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{11u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{9u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("29: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{7u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("30: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_size_t{7u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("31: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("32: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{12u} << matrix_size_t{9u} << matrix_size_t{12u} << matrix_size_t{9u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};

    // additional tests
    QTest::newRow("33: different matrixes") << IntMatrix{{4, 7}, 5} << IntMatrix{{5, 7}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("34: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("35: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{26u} << matrix_size_t{22u} << matrix_size_t{26u} << matrix_size_t{22u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("36: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{31u} << matrix_size_t{26u} << matrix_size_t{31u} << matrix_size_t{26u} << matrix_opt_size_t{2u} << matrix_opt_size_t{2u};
    QTest::newRow("37: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{3u} << matrix_opt_size_t{2u};
    QTest::newRow("38: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::ALL_DIFFERENT << matrix_size_t{33u} << matrix_size_t{28u} << matrix_size_t{33u} << matrix_size_t{28u} << matrix_opt_size_t{3u} << matrix_opt_size_t{3u};
    QTest::newRow("39: same matrix") << IntMatrix{{16, 22}, 5} << IntMatrix{{16, 22}, 5} << ConcatMode::DESTINATION_ALL << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};

    // empty matrix concatenation
    QTest::newRow("40: different matrixes") << IntMatrix{} << IntMatrix{} << ConcatMode::ALL_DIFFERENT << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_opt_size_t{} << matrix_opt_size_t{};
}
