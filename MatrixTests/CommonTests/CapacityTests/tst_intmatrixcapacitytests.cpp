...
void IntMatrixCapacityTests::testSplitByRow_data()
{
    ...
    QTest::newRow("1: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("2: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("6: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("7: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow("8: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow("9: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("11: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("14: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("15: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("16: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("17: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("18: medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};

    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 17}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{21u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};

    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 8}, 2} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 8}, 2} << matrix_size_t{7u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 15}, 2} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    // QTest::newRow(": medium source matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 17}, 2} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{21u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u};

    // QTest::newRow(": large source matrix") << IntMatrix{{25, 20}, -3} << IntMatrix{{18, 9}, 2} << matrix_size_t{11u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{31u} << matrix_size_t{25u} << matrix_size_t{22u} << matrix_size_t{20u} << matrix_opt_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{4u} << matrix_opt_size_t{0u};
    // QTest::newRow(": large source matrix") << IntMatrix{{25, 20}, -3} << IntMatrix{} << matrix_size_t{11u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{31u} << matrix_size_t{25u} << matrix_size_t{14u} << matrix_size_t{20u} << matrix_opt_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
}
...
void IntMatrixCapacityTests::testSplitByColumn_data()
{
    ...
    QTest::newRow("1: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("2: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{6u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{6u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("6: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{17, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("7: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("8: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 6}, 2} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 6}, 2} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 6}, 2} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("11: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 7}, 2} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: medium source matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{17, 8}, 2} << matrix_size_t{7u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    QTest::newRow("13: large source matrix") << IntMatrix{{20, 25}, -3} << IntMatrix{{9, 18}, 2} << matrix_size_t{11u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{25u} << matrix_size_t{31u} << matrix_size_t{20u} << matrix_size_t{22u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{4u};
    QTest::newRow("14: large source matrix") << IntMatrix{{20, 25}, -3} << IntMatrix{} << matrix_size_t{11u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{25u} << matrix_size_t{31u} << matrix_size_t{20u} << matrix_size_t{14u} << matrix_opt_size_t{2u} << matrix_opt_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
}
