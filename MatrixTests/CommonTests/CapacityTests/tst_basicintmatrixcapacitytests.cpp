...
void BasicIntMatrixCapacityTests::testVectorConstructor()
{
...
void BasicIntMatrixCapacityTests::testVectorConstructor_data()
{
    ...
    QTest::newRow("5: capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << std::vector<int>(c_TwiceDecrMaxAllowedDimension * c_TwiceDecrMaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("6: capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << std::vector<int>(c_TwiceDecrMaxAllowedDimension * c_MaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("7: capped row and column capacity") << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << std::vector<int>(c_MaxAllowedDimension * c_TwiceDecrMaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("8: capped row and column capacity") << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << std::vector<int>(c_DecrMaxAllowedDimension * c_DecrMaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: capped row and column capacity") << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << std::vector<int>(c_DecrMaxAllowedDimension * c_MaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: capped row and column capacity") << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << std::vector<int>(c_MaxAllowedDimension * c_DecrMaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("12: capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{3u} << std::vector<int>(c_TwiceDecrMaxAllowedDimension * 3, 0) << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("13: capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{3u} << std::vector<int>(c_DecrMaxAllowedDimension * 3, 0) << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("15: capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{8u} << std::vector<int>(c_TwiceDecrMaxAllowedDimension * 8, 0) << c_MaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("17: capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{10u} << std::vector<int>(c_DecrMaxAllowedDimension * 10, 0) << c_MaxAllowedDimension << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("18: capped column capacity") << matrix_size_t{3u} << c_TwiceDecrMaxAllowedDimension << std::vector<int>(3 * c_TwiceDecrMaxAllowedDimension, 0) << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("19: capped column capacity") << matrix_size_t{3u} << c_DecrMaxAllowedDimension << std::vector<int>(3 * c_DecrMaxAllowedDimension, 0) << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("21: capped column capacity") << matrix_size_t{8u} << c_TwiceDecrMaxAllowedDimension << std::vector<int>(8 * c_TwiceDecrMaxAllowedDimension, 0) << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("23: capped column capacity") << matrix_size_t{10u} << c_DecrMaxAllowedDimension << std::vector<int>(10 * c_DecrMaxAllowedDimension, 0) << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    // additional tests with high/max capacities
    QTest::newRow("24: extra large matrix, no capped capacity") << c_HalfMaxAllowedDimension << c_HalfMaxAllowedDimension << std::vector<int>(c_HalfMaxAllowedDimension * c_HalfMaxAllowedDimension, 0) << c_FiveEighthsMaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("25: capped column capacity") << c_HalfMaxAllowedDimension << c_SevenEighthsMaxAllowedDimension << std::vector<int>(c_HalfMaxAllowedDimension * c_SevenEighthsMaxAllowedDimension, 0) << c_FiveEighthsMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
    QTest::newRow("26: capped row capacity") << c_SevenEighthsMaxAllowedDimension << c_HalfMaxAllowedDimension << std::vector<int>(c_SevenEighthsMaxAllowedDimension * c_HalfMaxAllowedDimension, 0) << c_MaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("27: capped row and column capacity") << c_SevenEighthsMaxAllowedDimension << c_SevenEighthsMaxAllowedDimension << std::vector<int>(c_SevenEighthsMaxAllowedDimension * c_SevenEighthsMaxAllowedDimension, 0) << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
}
...
void BasicIntMatrixCapacityTests::testIdenticalElementsConstructor_data()
{
    ...
    QTest::newRow("5: capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("6: capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("7: capped row and column capacity") << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("8: capped row and column capacity") << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: capped row and column capacity") << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: capped row and column capacity") << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("12: capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{3u} << 0 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("13: capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{3u} << 0 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("15: capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{8u} << 0 << c_MaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("17: capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{10u} << 0 << c_MaxAllowedDimension << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("18: capped column capacity") << matrix_size_t{3u} << c_TwiceDecrMaxAllowedDimension << 0 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("19: capped column capacity") << matrix_size_t{3u} << c_DecrMaxAllowedDimension << 0 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("21: capped column capacity") << matrix_size_t{8u} << c_TwiceDecrMaxAllowedDimension << 0 << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("23: capped column capacity") << matrix_size_t{10u} << c_DecrMaxAllowedDimension << 0 << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    // additional tests with high/max capacities
    QTest::newRow("24: extra large matrix, no capped capacity") << c_HalfMaxAllowedDimension << c_HalfMaxAllowedDimension << 0 << c_FiveEighthsMaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("25: capped column capacity") << c_HalfMaxAllowedDimension << c_SevenEighthsMaxAllowedDimension << 0 << c_FiveEighthsMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
    QTest::newRow("26: capped row capacity") << c_SevenEighthsMaxAllowedDimension << c_HalfMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("27: capped row and column capacity") << c_SevenEighthsMaxAllowedDimension << c_SevenEighthsMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
}
...
void BasicIntMatrixCapacityTests::testDiagonalMatrixConstructor_data()
{
    ...
    QTest::newRow("5: capped capacity") << c_TwiceDecrMaxAllowedDimension << -2 << -3 << c_MaxAllowedDimension << matrix_opt_size_t{1u};
    QTest::newRow("6: capped capacity") << c_DecrMaxAllowedDimension << -2 << -3 << c_MaxAllowedDimension << matrix_opt_size_t{0u};
    QTest::newRow("7: capped capacity") << c_MaxAllowedDimension << -2 << -3 << c_MaxAllowedDimension << matrix_opt_size_t{0u};

    // additional tests with high/max capacities
    QTest::newRow("8: extra large matrix, no capped capacity") << c_HalfMaxAllowedDimension << -2 << -3 << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("9: capped capacity") << c_SevenEighthsMaxAllowedDimension << -2 << -3 << c_MaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
}
...
void BasicIntMatrixCapacityTests::testTranspose_data()
{
    ...
    QTest::newRow("12: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, 2} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("13: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, 2} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("14: extra large matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, 2} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("16: extra large matrix") << IntMatrix{{c_HalfMaxAllowedDimension, c_HalfMaxAllowedDimension}, 2} << c_FiveEighthsMaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("17: extra large matrix") << IntMatrix{{c_HalfMaxAllowedDimension, c_SevenEighthsMaxAllowedDimension}, 2} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_HalfToMaxCapacityOffset};
    QTest::newRow("18: extra large matrix") << IntMatrix{{c_SevenEighthsMaxAllowedDimension, c_HalfMaxAllowedDimension}, 2} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_HalfToMaxCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
    QTest::newRow("19: extra large matrix") << IntMatrix{{c_SevenEighthsMaxAllowedDimension, c_SevenEighthsMaxAllowedDimension}, 2} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
}
...
void BasicIntMatrixCapacityTests::testReserve_data()
{
    ...
    QTest::newRow("9: row capacity < rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{9u} << c_DecrMaxAllowedDimension << matrix_size_t{10u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << c_LargeDimensionColumnCapacityOffset;
    ...
    QTest::newRow("11: row capacity < rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{9u} << c_IncrMaxAllowedDimension << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << c_MaxDimensionColumnCapacityOffset;
    ...
    QTest::newRow("18: row capacity == rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{10u} << c_DecrMaxAllowedDimension << matrix_size_t{10u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << c_LargeDimensionColumnCapacityOffset;
    ...
    QTest::newRow("20: row capacity == rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{10u} << c_IncrMaxAllowedDimension << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << c_MaxDimensionColumnCapacityOffset;
    ...
    QTest::newRow("27: row capacity > rows count, column capacity < columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{0u} << c_DecrMaxAllowedDimension << matrix_size_t{8u} << c_LargeDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    QTest::newRow("28: row capacity > rows count, column capacity < columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{7u} << c_DecrMaxAllowedDimension << matrix_size_t{8u} << c_LargeDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    ...
    QTest::newRow("31: row capacity > rows count, column capacity < columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{8u} << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    QTest::newRow("32: row capacity > rows count, column capacity < columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << matrix_size_t{7u} << c_MaxAllowedDimension << matrix_size_t{8u} << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    ...
    QTest::newRow("36: row capacity > rows count, column capacity == columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{8u} << c_DecrMaxAllowedDimension << matrix_size_t{8u} << c_LargeDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    ...
    QTest::newRow("38: row capacity > rows count, column capacity == columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << matrix_size_t{8u} << c_MaxAllowedDimension << matrix_size_t{8u} << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    ...
    QTest::newRow("42: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{11u} << c_DecrMaxAllowedDimension << matrix_size_t{11u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << c_LargeDimensionColumnCapacityOffset;
    ...
    QTest::newRow("44: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{11u} << c_IncrMaxAllowedDimension << matrix_size_t{11u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << c_MaxDimensionColumnCapacityOffset;
    ...
    QTest::newRow("48: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{12u} << c_DecrMaxAllowedDimension << matrix_size_t{12u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{1u} << c_LargeDimensionColumnCapacityOffset;
    ...
    QTest::newRow("50: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{12u} << c_IncrMaxAllowedDimension << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << c_MaxDimensionColumnCapacityOffset;
    ...
    QTest::newRow("54: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{13u} << c_DecrMaxAllowedDimension << matrix_size_t{13u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{1u} << c_LargeDimensionColumnCapacityOffset;
    ...
    QTest::newRow("56: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << matrix_size_t{13u} << c_IncrMaxAllowedDimension << matrix_size_t{13u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << c_MaxDimensionColumnCapacityOffset;
    QTest::newRow("57: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{9u} << c_DecrMaxAllowedDimension << matrix_size_t{9u} << c_LargeDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    QTest::newRow("58: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{10u} << c_DecrMaxAllowedDimension << matrix_size_t{10u} << c_LargeDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("59: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{11u} << c_DecrMaxAllowedDimension << matrix_size_t{11u} << c_LargeDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("60: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_LargeDimensionRowCapacityOffset << c_LargeDimensionColumnCapacityOffset;
    QTest::newRow("61: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimensionRowCapacityOffset << c_MaxDimensionColumnCapacityOffset;
    QTest::newRow("62: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << c_IncrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimensionRowCapacityOffset << c_MaxDimensionColumnCapacityOffset;
    ...
    QTest::newRow("66: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxDimensionRowCapacityOffset << c_LargeDimensionColumnCapacityOffset;
    ...
    QTest::newRow("68: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_MaxAllowedDimension << c_IncrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << c_MaxDimensionColumnCapacityOffset;
    QTest::newRow("69: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << matrix_size_t{9u} << c_MaxAllowedDimension << matrix_size_t{9u} << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    QTest::newRow("70: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_size_t{10u} << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("71: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << matrix_size_t{11u} << c_MaxAllowedDimension << matrix_size_t{11u} << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("72: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxDimensionRowCapacityOffset << c_LargeDimensionColumnCapacityOffset;
    QTest::newRow("73: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << c_MaxDimensionColumnCapacityOffset;
    QTest::newRow("74: row capacity > rows count, column capacity > columns count") << IntMatrix{{10, 8}, -2} << c_IncrMaxAllowedDimension << c_IncrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << c_MaxDimensionColumnCapacityOffset;
    QTest::newRow("75: row capacity < rows count, column capacity < columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_ThreeTimesDecrMaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("76: row capacity < rows count, column capacity == columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_ThreeTimesDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("77: row capacity < rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_ThreeTimesDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("78: row capacity < rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_ThreeTimesDecrMaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("79: row capacity == rows count, column capacity < columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("80: row capacity == rows count, column capacity == columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("81: row capacity == rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("82: row capacity == rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("83: row capacity > rows count, column capacity < columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("84: row capacity > rows count, column capacity < columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("85: row capacity > rows count, column capacity == columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("86: row capacity > rows count, column capacity == columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("87: row capacity > rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("88: row capacity > rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("89: row capacity > rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("90: row capacity > rows count, column capacity > columns count") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
...
void BasicIntMatrixCapacityTests::testEraseRow_data()
{
    ...
    QTest::newRow("19: max allowed dimension, less rows than columns") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {0u}}};
    QTest::newRow("20: max allowed dimension, less rows than columns") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{static_cast<matrix_size_t>(c_DecrHalfMaxAllowedDimension - 1), c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {0u}}};
    QTest::newRow("21: max allowed dimension, less rows than columns") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("22: max allowed dimension, less rows than columns") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("23: max allowed dimension, less rows than columns") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    ...
    QTest::newRow("30: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("31: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("32: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    ...
    QTest::newRow("34: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("35a: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
        QTest::newRow("36a: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}};
        QTest::newRow("37a: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
        QTest::newRow("38a: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
        QTest::newRow("39a: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    }
    else
    {
        QTest::newRow("35b: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {0u}}};
        QTest::newRow("36b: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
        QTest::newRow("37b: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {1u}}};
        QTest::newRow("38b: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
        QTest::newRow("39b: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
    }

    QTest::newRow("40: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
    QTest::newRow("41: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("42: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("43: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("44: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {1u}}, {0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {3u}, {1u}}};
    QTest::newRow("45: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("46: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("47: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
}
...
void BasicIntMatrixCapacityTests::testEraseColumn_data()
{
    ...
    QTest::newRow("19: max allowed dimension, less columns than rows") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {2u}}};
    QTest::newRow("20: max allowed dimension, less columns than rows") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{static_cast<matrix_size_t>(c_DecrHalfMaxAllowedDimension - 1), c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {2u}}};
    QTest::newRow("21: max allowed dimension, less columns than rows") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("22: max allowed dimension, less columns than rows") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("23: max allowed dimension, less columns than rows") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << size_tuple_array_t{{c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    ...
    QTest::newRow("29: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}};
    QTest::newRow("30: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("31: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("32: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    ...
    QTest::newRow("34: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    ...
    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        ...
        QTest::newRow("36a: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}};
        QTest::newRow("37a: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
        QTest::newRow("38a: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
        QTest::newRow("39a: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    }
    else
    {
        ...
        QTest::newRow("36b: max allowed dimension, square matrix") << IntMatrix{{c_MaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
        QTest::newRow("37b: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {2u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {2u}}};
        QTest::newRow("38b: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
        QTest::newRow("39b: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
    }

    QTest::newRow("40: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}};
    QTest::newRow("41: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("42: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("43: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("44: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {2u}}, {0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {3u}}};
    QTest::newRow("45: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("46: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
    QTest::newRow("47: max allowed dimension, more columns than rows") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -2} << size_tuple_array_t{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}, {c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {0u}}};
}
...
void BasicIntMatrixCapacityTests::testCatByRow_data()
{
    ...
    QTest::newRow("15: different matrixes") << IntMatrix{{c_DecrMaxAllowedDimension, 22}, 5} << IntMatrix{{1, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("16: different matrixes") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, 22}, 5} << IntMatrix{{2, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("17: different matrixes") << IntMatrix{{1, 22}, -2} << IntMatrix{{c_DecrMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("18: different matrixes") << IntMatrix{{2, 22}, -2} << IntMatrix{{c_TwiceDecrMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("19_1a: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_TwiceDecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_2a: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_DecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        ...
        QTest::newRow("19_4a: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << c_DecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    ...
    {
        QTest::newRow("19_1b: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_ThreeTimesDecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_2b: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_TwiceDecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_3b: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_DecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_4b: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << c_TwiceDecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_5b: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << c_DecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        ...
        QTest::newRow("19_7b: different matrixes") << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << c_DecrMaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
...
void BasicIntMatrixCapacityTests::testCatByColumn_data()
{
    ...
    QTest::newRow("15: different matrixes") << IntMatrix{{22, c_DecrMaxAllowedDimension}, 5} << IntMatrix{{22, 1}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("16: different matrixes") << IntMatrix{{22, c_TwiceDecrMaxAllowedDimension}, 5} << IntMatrix{{22, 2}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("17: different matrixes") << IntMatrix{{22, 1}, -2} << IntMatrix{{22, c_DecrMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("18: different matrixes") << IntMatrix{{22, 2}, -2} << IntMatrix{{22, c_TwiceDecrMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("19_1a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_2a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        ...
        QTest::newRow("19_4a: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    ...
    {
        QTest::newRow("19_1b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_ThreeTimesDecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_2b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_3b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_4b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_5b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        ...
        QTest::newRow("19_7b: different matrixes") << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
...
void BasicIntMatrixCapacityTests::testSplitByRow_data()
{
    ...
    QTest::newRow("19: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("20: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{1, c_HalfMaxAllowedDimension}, 2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{3, c_HalfMaxAllowedDimension}, 2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{3u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("22: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("23: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{1, c_MaxAllowedDimension}, 2} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("24: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{3, c_MaxAllowedDimension}, 2} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("25a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("26a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{1, c_HalfMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("27a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{1, c_TwiceDecrMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
        QTest::newRow("28a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{1, c_MaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
        QTest::newRow("29a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_DecrHalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("30a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_DecrMaxAllowedDimension, c_HalfMaxAllowedDimension}, 2} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_DecrHalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("31a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, 2} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_DecrHalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
        QTest::newRow("32a: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_DecrMaxAllowedDimension, c_MaxAllowedDimension}, 2} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_DecrHalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
        QTest::newRow("33a: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("34a: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_ThreeTimesDecrMaxAllowedDimension, c_HalfMaxAllowedDimension}, 2} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{0u};
        QTest::newRow("35a: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_ThreeTimesDecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, 2} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u};
        QTest::newRow("36a: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, 2} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u};
        QTest::newRow("37a: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_DecrHalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    }
    else
    {
        ...
        QTest::newRow("29b: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_HalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        ...
        QTest::newRow("33b: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("34b: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_ThreeTimesDecrMaxAllowedDimension, c_HalfMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{0u};
        ...
        QTest::newRow("36b: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{{c_ThreeTimesDecrMaxAllowedDimension, c_MaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u};
        QTest::newRow("37b: NO capacity reserve for destination matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -3} << IntMatrix{} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{c_HalfMaxAllowedDimension} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    }
}
...
void BasicIntMatrixCapacityTests::testSplitByColumn_data()
{
    ...
    QTest::newRow("19: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("20: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, 1}, 2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, 3}, 2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("22: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("23: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, 1}, 2} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("24: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, 3}, 2} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("25a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("26a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, 1}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("27a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_TwiceDecrMaxAllowedDimension, 1}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
        QTest::newRow("28a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, 1}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    }
    else
    {
    ...
    QTest::newRow("29: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("30: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, c_DecrMaxAllowedDimension}, 2} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("31: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, 2} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("32: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_MaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, c_DecrMaxAllowedDimension}, 2} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("33a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("34a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, c_ThreeTimesDecrMaxAllowedDimension}, 2} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2};
        QTest::newRow("35a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_ThreeTimesDecrMaxAllowedDimension}, 2} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2};
        QTest::newRow("36a: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, 2} << c_DecrHalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2};
    }
    else
    {
        QTest::newRow("33b: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("34b: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, c_ThreeTimesDecrMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2};
        QTest::newRow("35b: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_ThreeTimesDecrMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2};
        QTest::newRow("36b: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, c_ThreeTimesDecrMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2};
    }

    QTest::newRow("37: NO capacity reserve for destination matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -3} << IntMatrix{} << matrix_size_t{1u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
}
...
void BasicIntMatrixCapacityTests::_buildMoveCopyConstructorsTestingTable()
{
    ...
    QTest::newRow("7: capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("8: capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("9: capped row and column capacity") << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("10: capped row and column capacity") << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("11: capped row and column capacity") << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: capped row and column capacity") << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("14: capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{3u} << 0 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("15: capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{3u} << 0 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("17: capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{8u} << 0 << c_MaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("19: capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{10u} << 0 << c_MaxAllowedDimension << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("20: capped column capacity") << matrix_size_t{3u} << c_TwiceDecrMaxAllowedDimension << 0 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("21: capped column capacity") << matrix_size_t{3u} << c_DecrMaxAllowedDimension << 0 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("23: capped column capacity") << matrix_size_t{8u} << c_TwiceDecrMaxAllowedDimension << 0 << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("25: capped column capacity") << matrix_size_t{10u} << c_DecrMaxAllowedDimension << 0 << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};

    // additional tests with high/max capacities
    QTest::newRow("26: extra large matrix, no capped capacity") << c_HalfMaxAllowedDimension << c_HalfMaxAllowedDimension << 0 << c_FiveEighthsMaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("27: capped column capacity") << c_HalfMaxAllowedDimension << c_SevenEighthsMaxAllowedDimension << 0 << c_FiveEighthsMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
    QTest::newRow("28: capped row capacity") << c_SevenEighthsMaxAllowedDimension << c_HalfMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_FiveEighthsMaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_HalfToFiveEighthsCapacityOffset};
    QTest::newRow("29: capped row and column capacity") << c_SevenEighthsMaxAllowedDimension << c_SevenEighthsMaxAllowedDimension << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset} << matrix_opt_size_t{c_SevenEighthsToMaxCapacityOffset};
}
...
void BasicIntMatrixCapacityTests::_buildAssignmentOperatorsTestingTable()
{
    ...
    QTest::newRow("7: destination matrix initially empty, capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("8: destination matrix initially empty, capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("9: destination matrix initially empty, capped row and column capacity") << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("10: destination matrix initially empty, capped row and column capacity") << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("11: destination matrix initially empty, capped row and column capacity") << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: destination matrix initially empty, capped row and column capacity") << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("14: destination matrix initially empty, capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{3u} << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("15: destination matrix initially empty, capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{3u} << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("17: destination matrix initially empty, capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{8u} << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("19: destination matrix initially empty, capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{10u} << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << c_MaxAllowedDimension << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("20: destination matrix initially empty, capped column capacity") << matrix_size_t{3u} << c_TwiceDecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("21: destination matrix initially empty, capped column capacity") << matrix_size_t{3u} << c_DecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("23: destination matrix initially empty, capped column capacity") << matrix_size_t{8u} << c_TwiceDecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("25: destination matrix initially empty, capped column capacity") << matrix_size_t{10u} << c_DecrMaxAllowedDimension << -1 << matrix_size_t{0u} << matrix_size_t{0u} << 0 << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("36: destination matrix initially NOT empty, capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -1 << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("37: destination matrix initially NOT empty, capped row and column capacity") << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << -1 << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("38: destination matrix initially NOT empty, capped row and column capacity") << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -1 << matrix_size_t{8u} << matrix_size_t{10u} << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("39: destination matrix initially NOT empty, capped row and column capacity") << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << -1 << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("40: destination matrix initially NOT empty, capped row and column capacity") << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << -1 << matrix_size_t{8u} << c_MaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("41: destination matrix initially NOT empty, capped row and column capacity") << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << -1 << c_MaxAllowedDimension << matrix_size_t{10u} << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("43: destination matrix initially NOT empty, capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{3u} << -1 << matrix_size_t{3u} << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("44: destination matrix initially NOT empty, capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{3u} << -1 << c_MaxAllowedDimension << matrix_size_t{3u} << -5 << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("45: destination matrix initially NOT empty, capped row capacity") << c_MaxAllowedDimension << matrix_size_t{4u} << -1 << c_DecrMaxAllowedDimension << matrix_size_t{3u} << -5 << c_MaxAllowedDimension << matrix_size_t{5u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("46: destination matrix initially NOT empty, capped row capacity") << c_TwiceDecrMaxAllowedDimension << matrix_size_t{8u} << -1 << c_DecrMaxAllowedDimension << matrix_size_t{10u} << -5 << c_MaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("47: destination matrix initially NOT empty, capped row capacity") << c_MaxAllowedDimension << matrix_size_t{10u} << -1 << matrix_size_t{10u} << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("48: destination matrix initially NOT empty, capped row capacity") << c_DecrMaxAllowedDimension << matrix_size_t{10u} << -1 << c_TwiceDecrMaxAllowedDimension << matrix_size_t{10u} << -5 << c_MaxAllowedDimension << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("49: destination matrix initially NOT empty, capped column capacity") << matrix_size_t{3u} << c_TwiceDecrMaxAllowedDimension << -1 << c_DecrMaxAllowedDimension << matrix_size_t{3u} << -5 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("50: destination matrix initially NOT empty, capped column capacity") << matrix_size_t{3u} << c_DecrMaxAllowedDimension << -1 << matrix_size_t{3u} << c_MaxAllowedDimension << -5 << matrix_size_t{3u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("51: destination matrix initially NOT empty, capped column capacity") << matrix_size_t{4u} << c_MaxAllowedDimension << -1 << matrix_size_t{3u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{5u} << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("52: destination matrix initially NOT empty, capped column capacity") << matrix_size_t{8u} << c_TwiceDecrMaxAllowedDimension << -1 << matrix_size_t{10u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{10u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("53: destination matrix initially NOT empty, capped column capacity") << matrix_size_t{10u} << c_MaxAllowedDimension << -1 << c_DecrMaxAllowedDimension << matrix_size_t{10u} << -5 << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("54: destination matrix initially NOT empty, capped column capacity") << matrix_size_t{10u} << c_DecrMaxAllowedDimension << -1 << matrix_size_t{10u} << c_TwiceDecrMaxAllowedDimension << -5 << matrix_size_t{12u} << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
}
...
void BasicIntMatrixCapacityTests::_buildResizeTestingTable()
{
    ...
    QTest::newRow("6: less rows, more columns") << IntMatrix{{10, 8}, -2} << matrix_size_t{9u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{12u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("13: equal rows, more columns") << IntMatrix{{10, 8}, -2} << matrix_size_t{10u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{12u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("18: more rows, less columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{7u} << -5 << c_DecrMaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("23: more rows, equal columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{8u} << -5 << c_DecrMaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("28: more rows, more columns") << IntMatrix{{10, 8}, -2} << matrix_size_t{11u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{12u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("33: more rows, more columns") << IntMatrix{{10, 8}, -2} << matrix_size_t{12u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{12u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("38: more rows, more columns") << IntMatrix{{10, 8}, -2} << matrix_size_t{13u} << c_DecrMaxAllowedDimension << -5 << matrix_size_t{13u} << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("40: more rows, more columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{9u} << -5 << c_DecrMaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("41: more rows, more columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{10u} << -5 << c_DecrMaxAllowedDimension << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("42: more rows, more columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{11u} << -5 << c_DecrMaxAllowedDimension << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("43: more rows, more columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << -5 << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("44: more rows, more columns") << IntMatrix{{10, 8}, -2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << -5 << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("48: more rows, more columns") << IntMatrix{{10, 8}, -2} << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("50: less rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{10u} << matrix_size_t{8u} << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("51: less rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{10u} << c_ThreeTimesDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("52: less rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << matrix_size_t{8u} << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("53: less rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("54: less rows, equal columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{10u} << c_TwiceDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("55: less rows, equal columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("56: less rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{10u} << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{1u};
    QTest::newRow("57: less rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{10u} << c_MaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxDimensionRowCapacityOffset << matrix_opt_size_t{0u};
    QTest::newRow("58: less rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("59: less rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_TwiceDecrMaxAllowedDimension << c_MaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("60: equal rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << matrix_size_t{8u} << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("61: equal rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("62: equal rows, equal columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("63: equal rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("64: equal rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_DecrMaxAllowedDimension << c_MaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("65: more rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << matrix_size_t{8u} << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("66: more rows, less columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_ThreeTimesDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("67: more rows, equal columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_TwiceDecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("68: more rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_DecrMaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("69: more rows, more columns") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << c_MaxAllowedDimension << c_MaxAllowedDimension << -5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
}
...
void BasicIntMatrixCapacityTests::_buildInsertRowTestingTable()
{
    ...
    QTest::newRow("10: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{0u} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("11: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension / 2 - 1} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension / 2} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension / 2 + 1} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("14: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("15: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{0u} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("16: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{c_DecrMaxAllowedDimension / 2} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("17: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{c_DecrMaxAllowedDimension} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
}
...
void BasicIntMatrixCapacityTests::_buildInsertColumnTestingTable()
{
    ...
    QTest::newRow("10: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{0u} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("11: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension / 2 - 1} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension / 2} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension / 2 + 1} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("14: extra large matrix") << IntMatrix{{c_DecrMaxAllowedDimension, c_TwiceDecrMaxAllowedDimension}, -2} << matrix_size_t{c_TwiceDecrMaxAllowedDimension} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("15: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{0u} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("16: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{c_DecrMaxAllowedDimension / 2} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("17: extra large matrix") << IntMatrix{{c_TwiceDecrMaxAllowedDimension, c_DecrMaxAllowedDimension}, -2} << matrix_size_t{c_DecrMaxAllowedDimension} << 5 << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
}
