...
void BasicIntMatrixCapacityTests::testCatByRow_data()
{
    ...
    QTest::newRow("2: different matrixes") << IntMatrix{{5, 7}, -2} << IntMatrix{{4, 7}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{10, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("4: different matrixes") << IntMatrix{{10, 22}, -2} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{26u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("5: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{1, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u};
    QTest::newRow("6: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{2, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u};
    QTest::newRow("7: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{3, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("8: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{4, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("9: different matrixes") << IntMatrix{{16, 22}, 5} << IntMatrix{{5, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("10: different matrixes") << IntMatrix{{1, 22}, -2} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{17u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("11: different matrixes") << IntMatrix{{2, 22}, -2} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("12: different matrixes") << IntMatrix{{3, 22}, -2} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{19u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("13: different matrixes") << IntMatrix{{4, 22}, -2} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{20u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("14: different matrixes") << IntMatrix{{5, 22}, -2} << IntMatrix{{16, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("15: different matrixes") << IntMatrix{{c_LargeDimension2, 22}, 5} << IntMatrix{{1, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("16: different matrixes") << IntMatrix{{c_LargeDimension1, 22}, 5} << IntMatrix{{2, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("17: different matrixes") << IntMatrix{{1, 22}, -2} << IntMatrix{{c_LargeDimension2, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("18: different matrixes") << IntMatrix{{2, 22}, -2} << IntMatrix{{c_LargeDimension1, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("19_1a: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension1 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_2a: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_3a: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_4a: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_5a: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_6a: different matrixes") << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    }
    else
    {
        QTest::newRow("19_1b: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension0 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_2b: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension1 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_3b: different matrixes") << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_4b: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension1 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_5b: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_6b: different matrixes") << IntMatrix{{c_HalfMaxAllowedDimension, 22}, 5} << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_7b: different matrixes") << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_DecrHalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_LargeDimension2 << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
        QTest::newRow("19_8b: different matrixes") << IntMatrix{{c_IncrHalfMaxAllowedDimension, 22}, -2} << IntMatrix{{c_HalfMaxAllowedDimension, 22}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    }

    QTest::newRow("20: same matrix") << IntMatrix{{4, 7}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: same matrix") << IntMatrix{{16, 22}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
}
...
void BasicIntMatrixCapacityTests::testCatByColumn_data()
{
    ...
    QTest::newRow("2: different matrixes") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{26u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("4: different matrixes") << IntMatrix{{22, 10}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{26u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("7: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 3}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    QTest::newRow("8: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 4}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("9: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{21u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("10: different matrixes") << IntMatrix{{22, 1}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{17u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("11: different matrixes") << IntMatrix{{22, 2}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{18u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("12: different matrixes") << IntMatrix{{22, 3}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{19u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("13: different matrixes") << IntMatrix{{22, 4}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("14: different matrixes") << IntMatrix{{22, 5}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{21u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("15: different matrixes") << IntMatrix{{22, c_LargeDimension2}, 5} << IntMatrix{{22, 1}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("16: different matrixes") << IntMatrix{{22, c_LargeDimension1}, 5} << IntMatrix{{22, 2}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("17: different matrixes") << IntMatrix{{22, 1}, -2} << IntMatrix{{22, c_LargeDimension2}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    QTest::newRow("18: different matrixes") << IntMatrix{{22, 2}, -2} << IntMatrix{{22, c_LargeDimension1}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("19_1a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension1 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_2a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_3a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_4a: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_5a: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_6a: different matrixes") << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    }
    else
    {
        QTest::newRow("19_1b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension0 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_2b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension1 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_3b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_4b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension1 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_5b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_6b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_7b: different matrixes") << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_LargeDimension2 << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
        QTest::newRow("19_8b: different matrixes") << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_HalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
    }

    QTest::newRow("20: same matrix") << IntMatrix{{7, 4}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: same matrix") << IntMatrix{{22, 16}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u};
}
...
void BasicIntMatrixCapacityTests::testSplitByRow_data()
{
    ...
    QTest::newRow("3: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("6: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("7: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("8: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("11: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("14: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("15: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("16: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("17: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("18: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
...
void BasicIntMatrixCapacityTests::testSplitByColumn_data()
{
    ...
    QTest::newRow("3: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("6: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("7: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("8: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("11: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("14: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("15: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("16: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("17: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("18: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
