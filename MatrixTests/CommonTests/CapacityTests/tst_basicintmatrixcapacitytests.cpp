...
void BasicIntMatrixCapacityTests::testEraseRow_data()
{
    ...
    QTest::newRow("38: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension1}, -2} << size_tuple_array_t{{c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("39: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension1}, -2} << size_tuple_array_t{{c_IncrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_HalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_DecrHalfMaxAllowedDimension, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
    QTest::newRow("40: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension1}, -2} << size_tuple_array_t{{0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {1u}, {1u}}, {0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {2u}, {1u}}, {0u, c_MaxAllowedDimension, c_MaxAllowedDimension, {3u}, {1u}}};
    QTest::newRow("41: max allowed dimension, more rows than columns") << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension1}, -2} << size_tuple_array_t{{c_LargeDimension2, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_LargeDimension1, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}, {c_LargeDimension0, c_MaxAllowedDimension, c_MaxAllowedDimension, {0u}, {1u}}};
