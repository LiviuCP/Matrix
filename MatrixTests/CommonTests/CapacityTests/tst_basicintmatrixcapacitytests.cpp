...
void BasicIntMatrixCapacityTests::testCatByColumn_data()
{
    ...
    QTest::newRow("4: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("5: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("6: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{3u};
    ...
    QTest::newRow("10: different matrixes") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("11: different matrixes") << IntMatrix{{7, 5}, -2} << IntMatrix{{7, 4}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    ...
    QTest::newRow("15: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{26u} << matrix_size_t{31u} << matrix_size_t{26u} << matrix_size_t{31u} << matrix_opt_size_t{2u} << matrix_opt_size_t{5u};
    QTest::newRow("16: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{6u};
    QTest::newRow("17: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 10}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{28u} << matrix_size_t{33u} << matrix_size_t{28u} << matrix_size_t{33u} << matrix_opt_size_t{3u} << matrix_opt_size_t{7u};
    ...
    QTest::newRow("20: different matrixes") << IntMatrix{{22, 10}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{26u} << matrix_size_t{31u} << matrix_size_t{26u} << matrix_size_t{31u} << matrix_opt_size_t{2u} << matrix_opt_size_t{5u};
    QTest::newRow("21: different matrixes") << IntMatrix{{22, 10}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << matrix_size_t{32u} << matrix_size_t{27u} << matrix_size_t{32u} << matrix_opt_size_t{2u} << matrix_opt_size_t{6u};
    QTest::newRow("22: different matrixes") << IntMatrix{{22, 10}, -2} << IntMatrix{{22, 16}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{28u} << matrix_size_t{33u} << matrix_size_t{28u} << matrix_size_t{33u} << matrix_opt_size_t{3u} << matrix_opt_size_t{7u};
    ...
    QTest::newRow("25: different matrixes") << IntMatrix{{22, 16}, 5} << IntMatrix{{22, 3}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{27u} << matrix_size_t{20u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("40: different matrixes") << IntMatrix{{22, 1}, -2} << IntMatrix{{22, c_LargeDimension0}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{2u};
    QTest::newRow("41: different matrixes") << IntMatrix{{22, 2}, -2} << IntMatrix{{22, c_LargeDimension0}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    ...
    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        ...
        QTest::newRow("43_7a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{2u};
        QTest::newRow("43_8a: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
        ...
        QTest::newRow("43_10a: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    ...
    else
    {
        ...
        QTest::newRow("43_9b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{3u};
        QTest::newRow("43_10b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{2u};
        QTest::newRow("43_11b: different matrixes") << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
        QTest::newRow("43_12b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{2u};
        QTest::newRow("43_13b: different matrixes") << IntMatrix{{22, c_HalfMaxAllowedDimension}, 5} << IntMatrix{{22, c_HalfMaxAllowedDimension}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
        ...
        QTest::newRow("43_15b: different matrixes") << IntMatrix{{22, c_IncrHalfMaxAllowedDimension}, -2} << IntMatrix{{22, c_DecrHalfMaxAllowedDimension}, 5} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_size_t{27u} << c_MaxAllowedDimension << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    ...
    QTest::newRow("47: same matrix") << IntMatrix{{7, 4}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("48: same matrix") << IntMatrix{{7, 4}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    ...
    QTest::newRow("53: same matrix") << IntMatrix{{22, 16}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{27u} << matrix_size_t{33u} << matrix_size_t{27u} << matrix_size_t{33u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u};
    QTest::newRow("54: same matrix") << IntMatrix{{22, 16}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{27u} << matrix_size_t{34u} << matrix_size_t{27u} << matrix_size_t{34u} << matrix_opt_size_t{2u} << matrix_opt_size_t{2u};
    QTest::newRow("55: same matrix") << IntMatrix{{22, 16}, 5} << IntMatrix{} << ConcatMode::TO_ITSELF << matrix_size_t{27u} << matrix_size_t{38u} << matrix_size_t{27u} << matrix_size_t{38u} << matrix_opt_size_t{2u} << matrix_opt_size_t{6u};
    ...
    QTest::newRow("64: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{6u} << matrix_size_t{10u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("65: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{7u} << matrix_size_t{10u} << matrix_size_t{7u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("66: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{10u} << matrix_size_t{8u} << matrix_size_t{10u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("67: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{9u} << matrix_size_t{10u} << matrix_size_t{9u} << matrix_size_t{10u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("68: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{6u} << matrix_size_t{11u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("69: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{7u} << matrix_size_t{11u} << matrix_size_t{7u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("70: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{11u} << matrix_size_t{8u} << matrix_size_t{11u} << matrix_opt_size_t{0u} << matrix_opt_size_t{2u};
    QTest::newRow("71: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{9u} << matrix_size_t{11u} << matrix_size_t{9u} << matrix_size_t{11u} << matrix_opt_size_t{1u} << matrix_opt_size_t{2u};
    QTest::newRow("72: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{6u} << matrix_size_t{12u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{3u};
    QTest::newRow("73: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{7u} << matrix_size_t{12u} << matrix_size_t{7u} << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{3u};
    QTest::newRow("74: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{8u} << matrix_size_t{12u} << matrix_size_t{8u} << matrix_size_t{12u} << matrix_opt_size_t{0u} << matrix_opt_size_t{3u};
    QTest::newRow("75: different matrixes") << IntMatrix{{7, 4}, 5} << IntMatrix{{7, 5}, -2} << ConcatMode::SOURCE_TO_DESTINATION << matrix_size_t{9u} << matrix_size_t{12u} << matrix_size_t{9u} << matrix_size_t{12u} << matrix_opt_size_t{1u} << matrix_opt_size_t{3u};
}
...
void BasicIntMatrixCapacityTests::testSplitByRow_data()
{
    ...
    QTest::newRow("1: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("2: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("6: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{6u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("7: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("8: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{7u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("11: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("14: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("15: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{16u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("16: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{17u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("17: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("18: capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 8}, 2} << matrix_size_t{8u} << matrix_size_t{9u} << matrix_size_t{19u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{9u} << matrix_size_t{19u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("19: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("20: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("22: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{5, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("23: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("24: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("25: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("26: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{6, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{7u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("27: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("28: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("29: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("30: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{7, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{8u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("31: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 13}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("32: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 14}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{17u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("33: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 15}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{18u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("34: NO capacity reserve for destination matrix") << IntMatrix{{15, 17}, -3} << IntMatrix{{8, 16}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{18u} << matrix_size_t{21u} << matrix_size_t{10u} << matrix_size_t{20u} << matrix_opt_size_t{5u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("35: NO capacity reserve for destination matrix") << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension1}, -3} << IntMatrix{} << c_LargeDimension2 << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << c_LargeDimension1 << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    else
    {
        ...
        QTest::newRow("49b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension2, c_LargeDimension1}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << c_LargeDimension1 << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("50b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension2, c_LargeDimension1}, -3} << IntMatrix{{c_LargeDimension0, c_HalfMaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{0u};
        QTest::newRow("51b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension2, c_LargeDimension1}, -3} << IntMatrix{{c_LargeDimension0, c_LargeDimension1}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u};
        QTest::newRow("52b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension2, c_LargeDimension1}, -3} << IntMatrix{{c_LargeDimension0, c_MaxAllowedDimension}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2} << matrix_opt_size_t{1u};
...
void BasicIntMatrixCapacityTests::testSplitByColumn_data()
{
    ...
    QTest::newRow("1: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("2: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("3: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{16u} << matrix_size_t{6u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("4: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{6u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("5: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{6u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("6: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_size_t{6u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{19u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("7: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{16u} << matrix_size_t{7u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("8: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("9: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("10: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_size_t{7u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{19u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("11: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{16u} << matrix_size_t{8u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("12: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("13: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{8u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("14: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_size_t{8u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{19u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("15: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{16u} << matrix_size_t{9u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{9u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("16: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{17u} << matrix_size_t{9u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{9u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("17: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{18u} << matrix_size_t{9u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{9u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("18: capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{8, 5}, 2} << matrix_size_t{8u} << matrix_size_t{19u} << matrix_size_t{9u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{19u} << matrix_size_t{9u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("19: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("20: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("21: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("22: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 5}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("23: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("24: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("25: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("26: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 6}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{7u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("27: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("28: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("29: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("30: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 7}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{8u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("31: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{13, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("32: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{14, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{17u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("33: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{15, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{18u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u};
    QTest::newRow("34: NO capacity reserve for destination matrix") << IntMatrix{{17, 15}, -3} << IntMatrix{{16, 8}, 2} << matrix_size_t{8u} << matrix_size_t{0u} << matrix_size_t{0u} << matrix_size_t{21u} << matrix_size_t{18u} << matrix_size_t{20u} << matrix_size_t{10u} << matrix_opt_size_t{2u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};
    QTest::newRow("35: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_MaxAllowedDimension}, -3} << IntMatrix{} << c_LargeDimension2 << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    ...
    QTest::newRow("38: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{} << c_LargeDimension1 << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("39: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_MaxAllowedDimension, 1}, 2} << c_LargeDimension1 << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{1u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    QTest::newRow("40: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_MaxAllowedDimension, 3}, 2} << c_LargeDimension1 << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_size_t{3u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{1u};

    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("41a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_MaxAllowedDimension}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("42a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_MaxAllowedDimension}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, 1}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("43a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_MaxAllowedDimension}, -3} << IntMatrix{{c_LargeDimension1, 1}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
        QTest::newRow("44a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_MaxAllowedDimension}, -3} << IntMatrix{{c_MaxAllowedDimension, 1}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{0u};
    }
    else
    {
    ...
    if constexpr (c_IsEvenMaxAllowedDimension)
    {
        QTest::newRow("49a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{} << c_DecrHalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        ...
        QTest::newRow("51a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_LargeDimension1, c_LargeDimension0}, 2} << c_DecrHalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2};
        QTest::newRow("52a: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension1}, 2} << c_DecrHalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_HalfMaxAllowedDimension / 2};
    }
    else
    {
        QTest::newRow("49b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_HalfMaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
        QTest::newRow("50b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_HalfMaxAllowedDimension, c_LargeDimension0}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2};
        QTest::newRow("51b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_LargeDimension1, c_LargeDimension0}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2};
        QTest::newRow("52b: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_MaxAllowedDimension, c_LargeDimension0}, 2} << c_HalfMaxAllowedDimension << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << c_MaxAllowedDimension << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{1u} << matrix_opt_size_t{c_IncrHalfMaxAllowedDimension / 2};
    }

    QTest::newRow("53: NO capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{} << matrix_size_t{1u} << matrix_size_t{0u} << matrix_size_t{0u} << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_LargeDimension1 << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
    QTest::newRow("54: capacity reserve for destination matrix") << IntMatrix{{c_LargeDimension1, c_LargeDimension2}, -3} << IntMatrix{{c_DecrHalfMaxAllowedDimension, c_IncrHalfMaxAllowedDimension}, 2} << matrix_size_t{1u} << c_LargeDimension0 << c_LargeDimension0 << c_MaxAllowedDimension << c_MaxAllowedDimension << c_LargeDimension1 << c_LargeDimension1 << matrix_opt_size_t{1u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u} << matrix_opt_size_t{0u};
