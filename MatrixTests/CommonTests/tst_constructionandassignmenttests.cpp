...
{
    StringMatrix matrix{2, 3, {"1", "2", "3", "4", "5", "6"}};
...
{
    StringMatrix matrix{3, std::pair<std::string, std::string>{"2", "1"}};
...
{
    {
        const StringMatrix srcMatrix{2, 3, {"1", "2", "3", "4", "5", "6"}};
...
{
    StringMatrix srcMatrix{2, 3, {"1", "2", "3", "4", "5", "6"} };
...
void ConstructionAndAssignmentTests::testStringMatrixCopyAssignmentOperator()
{
    {
        const StringMatrix srcMatrix{2, 3, {"1", "2", "3", "4", "5", "6"}};
        StringMatrix destMatrix{3, 2, {"7", "8", "9", "10", "11", "12"}};
    ...
    {
        const StringMatrix srcMatrix{3, 4, "7"};
        StringMatrix destMatrix{2, 3, "8"};
    ...
    {
        const StringMatrix srcMatrix{4, 3, "9"};
        StringMatrix destMatrix{2, 3, "8"};
    ...
    {
        const StringMatrix srcMatrix{20, 20, "11"};
        StringMatrix destMatrix{2, 3, "8"};
    ...
    {
        const StringMatrix srcMatrix{22, 22, "12"};
        StringMatrix destMatrix{2, 3, "8"};
    ...
    {
        StringMatrix firstMatrix{2, 3, {"1", "2", "3", "4", "5", "6"}};
        StringMatrix secondMatrix{3, 2, {"7", "8", "9", "10", "11", "12"}};
        const StringMatrix thirdMatrix{2, 2, {"13", "14", "15", "16"}};
    ...
    // test cases when destination matrix already has the required capacity
    {
        const StringMatrix srcMatrix{3, 5, "-2"};
        StringMatrix destMatrix{3, 5, "7"};
    ...
    {
        const StringMatrix srcMatrix{9, 3, "-2"};
        StringMatrix destMatrix{4, 2, "7"};
...
void ConstructionAndAssignmentTests::testStringMatrixMoveAssignmentOperator()
{
...

    {
        StringMatrix firstMatrix{2, 3, {"1", "2", "3", "4", "5", "6"}};
        StringMatrix secondMatrix{3, 2, {"7", "8", "9", "10", "11", "12"}};
        StringMatrix thirdMatrix{2, 2, {"13", "14", "15", "16"}};
