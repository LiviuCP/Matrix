...
#define TEST_MATRIXES_SWAP(matrixType, primaryMatrix, secondaryMatrix)                                                 \
    ...
    std::swap(primaryMatrix, secondaryMatrix);                                                                         \
                                                                                                                       \
    if (primaryMatrix.getRowCapacity() != secondMatrix.getRowCapacity() ||                                             \
        primaryMatrix.getColumnCapacity() != secondMatrix.getColumnCapacity())                                         \
    {                                                                                                                  \
        QFAIL("Incorrect capacity of the first matrix after swap!");                                                   \
    }                                                                                                                  \
                                                                                                                       \
    if (secondaryMatrix.getRowCapacity() != firstMatrix.getRowCapacity() ||                                            \
        secondaryMatrix.getColumnCapacity() != firstMatrix.getColumnCapacity())                                        \
    {                                                                                                                  \
