...
namespace Matr
{
    ...
    static std::map<Errors, string> errorMessages
    {
        ...
        {    Errors::MATRIXES_ROWS_UNEQUAL_COLUMNS,                      string{"The number of columns of the first matrix is different from the number of lines of the second one"}                             },
        ...
        {    Errors::CURRENT_MATRIX_AS_ARG,                              string{"Current matrix (*this) has been passed as argument into the function. This is not allowed for this method."}                    },
