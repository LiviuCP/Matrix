...
namespace Matr
{
    enum class Errors
    {
        ...
        MAX_ALLOWED_ROWS_COUNT_EXCEEDED,
        MAX_ALLOWED_COLUMNS_COUNT_EXCEEDED,
    ...
    static std::map<Errors, string> errorMessages
    {
        ...
        {    Errors::MAX_ALLOWED_ROWS_COUNT_EXCEEDED,                    string{"The maximum allowed number of rows has been exceeded."}                                                                         },
        {    Errors::MAX_ALLOWED_COLUMNS_COUNT_EXCEEDED,                 string{"The maximum allowed number of columns has been exceeded."}                                                                      },
